...
import transcript_friction as tf  # noqa: E402 -- resolves via the sys.path insert above
import transcript_recurrence as tr  # noqa: E402 -- resolves via the sys.path insert above

---
name: refine-directive
description: |
  ALWAYS invoke this skill when a complex prompt needs enrichment before execution. Trigger phrases: "refine", "refine this", "improve this prompt".
argument-hint: "[input or context]"
allowed-tools: Read Write Edit Bash AskUserQuestion
---

# refine (study variant: directive)

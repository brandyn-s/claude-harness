...
generated plugin tree under `marketplace/` (another <!-- count:marketplace_files -->1,066<!-- /count -->
...
<!-- count:ambient_bytes -->169,826<!-- /count --> bytes (about <!-- count:ambient_tokens -->62,041<!-- /count --> tokens by the

...
|---|---|---|
| `marketplace/**` (<!-- count:marketplace_files -->1,066<!-- /count --> files) | `scripts/build-marketplace.py` | Self-contained plugin bundles. Edit the ORIGINALS in `skills/`, `hooks/`, `agents/`, `bin/`. Marked `linguist-generated`. |

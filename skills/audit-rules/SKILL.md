...
python3 ~/.claude/skills/audit-rules/scripts/scan_to_findings.py \
    --include-uncovered \
...
~/.claude/bin/audit-skill-oracle.py verify-fix \
...
```bash
python3 ~/.claude/skills/audit-rules/scripts/extract_forbidden_signatures.py
```
...
```bash
python3 ~/.claude/skills/audit-rules/scripts/detect_demotion_candidates.py
python3 ~/.claude/skills/audit-rules/scripts/detect_demotion_candidates.py \
...
```bash
~/.claude/bin/audit-skill-oracle.py set-triage-status \
    AUDIT-TRACKERS/rule-violations.findings.yaml \
...
```
python3 ~/.claude/skills/audit-rules/references/scan_violations.py
python3 ~/.claude/skills/audit-rules/references/scan_violations.py --rule encoding-missing-open  # filter
python3 ~/.claude/skills/audit-rules/references/scan_violations.py --json                        # machine output
```
...
```
python3 ~/.claude/skills/audit-rules/references/classify_rules.py
python3 ~/.claude/skills/audit-rules/references/classify_rules.py --rule encoding   # filter
python3 ~/.claude/skills/audit-rules/references/classify_rules.py --json
```
...
```
python3 ~/.claude/skills/audit-rules/references/lifecycle_check.py
python3 ~/.claude/skills/audit-rules/references/lifecycle_check.py --days 60 --json
python3 ~/.claude/skills/audit-rules/references/lifecycle_check.py --window 21  # pre/post comparison window (default 14d)
```

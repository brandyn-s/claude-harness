...
# sections 5 and 12.2. Real runs print the notice and refuse without
...
FIXTURE_STATUS_NOTICE = (
    "NOTICE: this A/B fixture is RETIRED (2026-09-04): the baseline is at ceiling on Fable 5.1 "
    "(45/45), the May 2026 edge was a single claim both arms now answer, and under the corrected "
    "oracle the two arms are identical on the primary metric. See harness/PROBLEM.md section 9 and "
    "docs/research-skills-root-cause.md sections 5 and 12.2. A run against it produces no new "
    "measurement."
)

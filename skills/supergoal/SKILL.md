...
```bash
python3 ~/.claude/skills/supergoal/scripts/parse_plan.py "$0" --state-dir ~/.claude/supergoal/
```
...
```bash
python3 ~/.claude/skills/supergoal/scripts/check_prior_arcs.py ~/.claude/supergoal/<slug>/state.json
```
...
```bash
python3 ~/.claude/skills/supergoal/scripts/write_terminal.py ~/.claude/supergoal/<slug>/state.json <exit-reason>
```

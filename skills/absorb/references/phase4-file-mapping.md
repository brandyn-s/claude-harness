...
| Skill design & triggers | The actual skill SKILL.md in `~/.claude/skills/<matching-skill>/`. Compare **capability-to-capability**, not skill-to-skill — their one skill may map to your 3 skills, or vice versa. Ask "what capability does this provide?" then find how your architecture delivers that capability (may be a skill, a hook, a rule, or a workflow across multiple tools). |

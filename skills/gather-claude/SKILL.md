...
```bash
python3 ~/.claude/skills/gather-claude/scripts/fetch_window.py --since {since_date} --out /tmp/claude/gc-run \
...
`uncharted-vs-refuted.md`): do not over-reject current features — absence of a

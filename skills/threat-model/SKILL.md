...
```bash
python3 ~/.claude/skills/threat-model/scripts/verify_claims.py threat-model.md --root . --ndjson run.ndjson \
  [--claims claims.json --project <indexed-project>] --strict
python3 ~/.claude/skills/threat-model/scripts/model_history.py append run.ndjson --repo "<repo>"
```

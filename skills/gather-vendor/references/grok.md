...
grep -hoE "grok-[0-9a-z.\-]+" ~/.claude/bin/x-monitor.py ~/.claude/skills/roundtable/scripts/adapters/xai_adapter.py | sort -u  # live pins -> Step 2
```
...
```bash
FC="python3 ~/.claude/skills/gather-vendor/scripts/fetch_channel.py"

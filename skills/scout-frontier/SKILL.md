...
```bash
python3 "$HOME/.claude/skills/scout-frontier/scripts/validate_constraint_trace.py" /path/to/trace.yaml
```
...
```bash
python3 ~/.claude/skills/scout-frontier/scripts/score_rubric.py \

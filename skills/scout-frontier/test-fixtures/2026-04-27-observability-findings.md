...
*Generated by /scout-frontier worker dispatch on 2026-04-27. Method follows the protocol in `~/.claude/skills/scout-frontier/SKILL.md` (Steps 1-6). Search venues per `references/search-venues.md`. Distances scored per `references/paradigm-distance-rubric.md`.*

...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gather-vendor/scripts/probe_models.py <vendor> <pins-from-step-1>
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/gather-vendor/scripts/fetch_channel.py <url> '<marker>' <outpath>
```

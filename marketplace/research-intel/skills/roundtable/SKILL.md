...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/synthesize.py --output <results-dir>
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/audit_concessions.py <results-dir>
# or with strict-mode exit code:
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/audit_concessions.py <results-dir> --strict
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/validate_claims.py <results-dir>
# default checks rounds 3-5; tag --strict to exit non-zero on FAIL:
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/validate_claims.py <results-dir> --strict
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/skills/roundtable/scripts/tag_run.py \
  --run-dir <results-dir> \
  --useful yes \

...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/bin/kb-dedup.py "<entry summary>" "<second entry summary>" ...
```
...
```bash
python3 ${CLAUDE_PLUGIN_ROOT}/bin/kb-entry-budget.py <topic-slug> --entry-file /tmp/claude/<draft>.md
```

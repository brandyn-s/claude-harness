...
# section 6. Real runs print the notice and refuse without --acknowledge-retired-fixture;
# --plan-only never needs it.
FIXTURE_STATUS = "retired"
FIXTURE_STATUS_SINCE = "2026-09-04"
FIXTURE_STATUS_NOTICE = (
    "NOTICE: this A/B fixture is RETIRED (2026-09-04): both arms score 180/180 on Opus 4.8 "
    "(2026-05-31) and on Fable 5.1 (2026-09-03), so the fixture is at ceiling and cannot "
    "distinguish the arms. See harness/PROBLEM.md section 9 and "
    "docs/research-skills-root-cause.md section 6. A run against it produces no new measurement."
)

...
metadata:
  ...
  version: "1.0"
allowed-tools: Read Grep Glob Bash AskUserQuestion mcp__crowdstrike__* mcp__tenable__* mcp__airlock__* mcp__msgraph__* mcp__linear-server__* mcp__00000000-0000-4000-8000-000000000002__* mcp__ramp__* mcp__code-search__* mcp__code-graph__* mcp__tavily__tavily_search
...
TRIGGER: 5+ findings.
FOLLOW: `${CLAUDE_PLUGIN_ROOT}/skills/_shared/adversarial-validation.md`

...
| `p/gitlab` | GitLab-maintained security rules (hosted on Semgrep registry) | GitLab |

### Third-Party Rulesets

(Rulesets maintained outside the Semgrep registry — typically cloned from GitHub.)

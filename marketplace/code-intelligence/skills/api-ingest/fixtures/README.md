...
verify-the-external-contract rule):
    ...
    /api-ingest ${CLAUDE_PLUGIN_ROOT}/skills/api-ingest/fixtures/2a-openapi-minimal.json --name fixture-2a
    /api-ingest ${CLAUDE_PLUGIN_ROOT}/skills/api-ingest/fixtures/2b-llms-full.txt        --name fixture-2b
    /api-ingest ${CLAUDE_PLUGIN_ROOT}/skills/api-ingest/fixtures/2d-postman-collection.json --name fixture-2d

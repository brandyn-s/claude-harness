...
> For full Cypher syntax reference, edge types, and node labels: see the `code-graph-reference` skill that the code-graph server installs (`${CLAUDE_PLUGIN_ROOT}/skills/code-graph-reference/SKILL.md``
